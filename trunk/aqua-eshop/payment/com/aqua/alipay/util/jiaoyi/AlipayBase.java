package com.aqua.alipay.util.jiaoyi;
...
public class AlipayBase {
	...
	public static void LogResult(String sWord){
		...
		try {
			...
			sb.append("D:").append(osPath).append("alipay_log").append(System.currentTimeMillis()).append(".txt");
			FileWriter writer = new FileWriter(osPath.toString());
			writer.write(sWord);
			writer.close();
		} catch (Exception e) {
			e.printStackTrace();
