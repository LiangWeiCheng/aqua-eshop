...
public class CompassIndexBuilder implements InitializingBean {
	...
	private static final Log log = LogFactory.getLog(CompassIndexBuilder.class);
    ...
    private Thread indexThread = new Thread() {
        ...
        public void run() {
            try {
                ...
                log.info("system init Compass context开始更新索引...");
                ...
                log.info("system init Compass context完成更新索引...");
                log.info("system init Compass context更新索引的时间是:" + costTime + " milliseconds");
